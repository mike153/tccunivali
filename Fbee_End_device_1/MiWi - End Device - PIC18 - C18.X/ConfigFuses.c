/*****************************************************************************
 *
 *              ConfigFuses.c -- user main program
 *
 *****************************************************************************
...
#include "Compiler.h"
        ...
        const rom unsigned char config1H = 0b00000010;      // era:0000.0110 - HSPLL oscillator
    ...
    #pragma config POSCMOD = XT, FNOSC = PRIPLL, FPBDIV = DIV_4, WDTPS = PS2048
#endif
